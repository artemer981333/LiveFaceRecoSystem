...
mtcnn::mtcnn()
{
    ...
    std::string model2 = project_path+"/models/mtcnn/det2.bin";
    std::string param3=  project_path+"/models/mtcnn/det3.param";
    std::string model3 = project_path+"/models/mtcnn/det3.bin";

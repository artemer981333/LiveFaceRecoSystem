...
mtcnn::mtcnn()
{
	//чтение моделей распознавания
	std::string param1 = "./models/mtcnn/det1.param";
	std::string model1 = "./models/mtcnn/det1.bin";
	std::string param2 = "./models/mtcnn/det2.param";
	std::string model2 = "./models/mtcnn/det2.bin";
	std::string param3 = "./models/mtcnn/det3.param";
	std::string model3 = "./models/mtcnn/det3.bin";
...
void mtcnn::detect(ncnn::Mat& img_, std::vector<Bbox>& finalBbox_)
{
	...
	count = 0;
	for(auto it = firstBbox_.begin(); it != firstBbox_.end(); it++)
	{
		if ((*it).exist)
		{
			ncnn::Mat tempIm;
